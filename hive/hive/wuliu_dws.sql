...
create external table dws_trade_org_cargo_type_order_1d(
	...
	stored as orc
	location '/bigdata_warehouse/tms02/dws/dws_trade_org_cargo_type_order_1d'
...
create external table dws_trade_org_cargo_type_order_nd(
	...
	partitioned by(`dt` string comment '统计日期')
	stored as orc
	location '/bigdata_warehouse/tms02/dws/dws_trade_org_cargo_type_order_nd'
	tblproperties('orc.compress' = 'snappy');
...
create external table dws_trans_org_receive_1d(
	...
	partitioned by (`dt` string comment '统计日期')
	stored as orc
	location '/bigdata_warehouse/tms02/dws/dws_trans_org_receive_1d/'
	tblproperties ('orc.compress'='snappy');
...
create external table dws_trans_org_receive_nd(
	...
	partitioned by (`dt` string comment '统计日期')
	stored as orc
	location '/bigdata_warehouse/tms02/dws/dws_trans_org_receive_nd/'
	tblproperties ('orc.compress'='snappy');
...
create external table dws_trans_dispatch_1d(
	...
	partitioned by (`dt` string comment '统计日期')
	stored as orc
	location '/bigdata_warehouse/tms02/dws/dws_trans_dispatch_1d/'
	tblproperties('orc.compress'='snappy');
...
create external table dws_trans_dispatch_td(
	...
	partitioned by (`dt` string comment '统计日期')
	stored as orc
	location '/bigdata_warehouse/tms02/dws/dws_trans_dispatch_td'
	tblproperties('orc.compress'='snappy');
...
create external table dws_trans_org_truck_model_type_trans_finish_1d(
	...
	partitioned by (`dt` string comment '统计日期')
	stored as orc
	location '/bigdata_warehouse/tms02/dws/dws_trans_org_truck_model_type_trans_finish_1d/'
	tblproperties('orc.compress'='snappy');
...
create external table dws_trans_shift_trans_finish_nd(
	...
	partitioned by (`dt` string comment '统计日期')
	stored as orc
	location '/bigdata_warehouse/tms02/dws/dws_trans_shift_trans_finish_nd/'
	tblproperties('orc.compress'='snappy');
...
create external table dws_trans_org_deliver_suc_1d(
	...
	partitioned by (`dt` string comment '统计日期')
	stored as orc
	location '/bigdata_warehouse/tms02/dws/dws_trans_org_deliver_suc_1d/'
	tblproperties('orc.compress'='snappy');
...
create external table dws_trans_org_deliver_suc_nd(
	...
	partitioned by (`dt` string comment '统计日期')
	stored as orc
	location '/bigdata_warehouse/tms02/dws/dws_trans_org_deliver_suc_nd/'
	tblproperties('orc.compress'='snappy');
...
create external table dws_trans_org_sort_1d(
	...
	partitioned by (`dt` string comment '统计日期')
	stored as orc
	location '/bigdata_warehouse/tms02/dws/dws_trans_org_sort_1d/'
	tblproperties('orc.compress'='snappy');
...
create external table dws_trans_org_sort_nd(
	...
	partitioned by (`dt` string comment '统计日期')
	stored as orc
	location '/bigdata_warehouse/tms02/dws/dws_trans_org_sort_nd/'
	tblproperties('orc.compress'='snappy');